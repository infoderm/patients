...
const exampleHealthoneReport = `A1\\65859278\\Marks and Sons\\
...
const exampleHealthoneLab = `A1\\58472766\\Raynor, Roob and Maggio\\
...
client(__filename, () => {
	...
	macro(
		'should allow to attach documents to a patient by drag-and-drop (healthone report)',
		{
			firstname: 'Jane',
			lastname: 'Doe',
			contents: exampleHealthoneReport,
			filename: 'test.xyz',
			method: dropFiles,
			expected: [
				{text: '48486755'},
